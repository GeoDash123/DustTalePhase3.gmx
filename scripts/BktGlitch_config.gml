/// BktGlitch_config(lineShift, lineSpeed, lineResolution, lineDrift, lineVerticalShift, jumbleness, jumbleSpeed, jumbleResolution, jumbleShift, noiseLevel, channelShift, channelDispersion, shakiness, intensity, rngSeed, time)
/*
